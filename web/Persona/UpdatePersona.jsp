<%-- 
    ...
    Created on : 27/08/2017, 06:52:45 PM
    Author     : home
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <%!String idPeople, documentPeople, fullName, gender, phone, address, email, registeredBy, codeState, codeArea, codePosition, codeCDep;%> 
        <%
            idPeople = request.getParameter("idPeo");
            documentPeople = request.getParameter("docuPeo");
            fullName = request.getParameter("fullNa");
            gender = request.getParameter("gen");
            phone = request.getParameter("pho");
            address = request.getParameter("add");
            email = request.getParameter("ema");
            registeredBy = request.getParameter("regisBy");
            codeState = request.getParameter("codSta");
            codeArea = request.getParameter("codAre");
            codePosition = request.getParameter("codPosi");
            codeCDep = request.getParameter("codCDe");
        %>
    <center>
        ...
        <form class="col s12">
            <div class="row">
                <div class="input-field col s6">
                    <input id="idPeople" type="number" class="validate" name="idPeople" value="<%=idPeople%>">
                    <label for="idPeople"><i class="zmdi zmdi-account-circle"></i>&nbsp; Codigo de Persona</label>
                </div>
                <div class="input-field col s6">
                    <input id="documentPeople" type="number" class="validate" name="documentPeople" value="<%=documentPeople%>">
                ...
                <div class="input-field col s6">
                    <input id="registeredBy" type="text" class="validate" name="registeredBy" value="<%=registeredBy%>">
                    <label for="registeredBy"><i class="zmdi zmdi-email"></i>&nbsp; Registrado Por</label>
                </div>
                <div class="input-field col s6">
                    <select name="codeState">
                        <option value="0" disabled selected><%=codeState%></option>
                        <%
                ...
                <div class="input-field col s6">
                    <select name="codeArea">
                        <option value="0" disabled selected><%=codeArea%></option>
                        <%
                ...
                <div class="input-field col s6">
                    <select name="codePosition">
                        <option value="0" disabled selected><%=codePosition%></option>
                        <%
                    ...
                    <div class="input-field col s6">
                        <select name="codeCDep">
                            <option value="0" disabled selected><%=codeCDep%></option>
                            <%
                ...
                <div class="row">
                    <div class="col s7 offset-s5">
                        <span class="flow-text">
                            <button name="btnModificar" id="btnModificar" class="waves-effect waves-light btn" formaction="../ServletPersona">Modificar</button>
                        </span>
                    </div>
                </div>    
            </div>
