<%-- 
    ...
    Created on : 26/08/2017, 12:06:38 AM
    Author     : home
--%>
...
<html>
    ...
    <body>
        ...
        <section class="ContentPage full-width">
            ...
            <%!String codePosition,namePosition;%>
            <%
                codePosition=request.getParameter("codPosi");
                namePosition=request.getParameter("namPosi");
            %>
            <center>
                <section>
                    <div class="row">
                        <h3>Actualízar Cargo</h3>
                        <hr class="style">
                    </div>
                </section>
            </center>
                ...
                <form class="col s12">
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="codePosition" type="number" class="validate" name="codePosition" value="<%=codePosition%>">
                            <label for="codePosition">Código Cargo</label>
                        </div>
                        <div class="input-field col s6">
                            <i class="zmdi zmdi-font prefix"></i>
                            <input id="namePosition" type="text" class="validate" name="namePosition" value="<%=namePosition%>">
                            <label for="namePosition">Nombre Cargo*</label>
                       </div>
                    </div>
                    <div class="input-field">
                        <div class="col-md-12 center">
                            <button id="btnModificar" name="btnModificar" class="waves-effect waves-light btn" formaction="../ServletPosition">Actualízar</button>
                        </div>
                    </div>
                </form>
            </div>                      
